...
public class CommandController {
    private static final String APP_NAME = "raspberrypi";
    ...
    public CommandController(Context context, Handler handler) {
    ...
    private void connectionFailed() {
        ...
        Bundle bundle = new Bundle();
        bundle.putString("toast", "Impossible de connecter l'appareil");
        msg.setData(bundle);
        handler.sendMessage(msg);

        // Start the service over to restart listening mode
        CommandController.this.start();
    }

    private void connectionLost() {
        Message msg = handler.obtainMessage(MainActivity.MESSAGE_TOAST);
        Bundle bundle = new Bundle();
        bundle.putString("toast", "La connexion a été perdu");
        msg.setData(bundle);
        handler.sendMessage(msg);
